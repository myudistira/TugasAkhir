...
try {
    ...
    $sql = "TRUNCATE TABLE test_sinyal_agg_low_norm";
    ...
    echo $sql . "<br>" . $e->getMessage();
     ...
     $sqlquery = $conn1->prepare("INSERT INTO test_sinyal_agg_low_norm (id_csv, Date)
		SELECT id_csv, date 
		FROM csv_test
		WHERE id_csv > 14");
	 $sqlquery->execute();
...
header("Location: import_sinyal_agg.php");
exit;
